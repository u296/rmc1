...
{
    let unit_step_size = [
        (1.0 + (direction[1] / direction[0]).powi(2) + (direction[2] / direction[0]).powi(2))
            .sqrt(),
        (1.0 + (direction[0] / direction[1]).powi(2) + (direction[2] / direction[1]).powi(2))
            .sqrt(),
        (1.0 + (direction[0] / direction[2]).powi(2) + (direction[1] / direction[2]).powi(2))
            .sqrt(),
    ];
